...
curl -fsSL https://raw.githubusercontent.com/drawlean/My-action/master/lean-lede/zzz-default-settings > package/lean/default-settings/files/zzz-default-settings
